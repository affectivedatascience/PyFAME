...
RIGHT_EYEBROW_IDX = [46, 53, 52, 65, 55, 107, 66, 105, 63, 70, 46]
...
LEFT_EYEBROW_IDX = [276, 283, 282, 295, 285, 336, 296, 334, 293, 300, 276]
NOSE_IDX = [168, 193, 122, 196, 236, 198, 209, 49, 48, 219, 235, 60, 242, 2, 290, 455, 294, 331, 429, 420, 456, 419, 351, 417, 168]
NOSE_WIDE_IDX = [168, 193, 122, 196, 174, 217, 209, 49, 129, 64, 98, 167, 164, 393, 327, 294, 278, 279, 429, 437, 399, 419, 351, 417, 168]
MOUTH_IDX = [164, 393, 391, 322, 410, 287, 273, 335, 406, 313, 18, 83, 182, 106, 43, 57, 186, 92, 165, 167, 164]
LIPS_OUTER_IDX = [61, 146, 91, 181, 84, 17, 314, 405, 321, 375, 291, 409, 270, 269, 267, 37, 39, 40, 185, 61]
LIPS_INNER_IDX = [78, 95, 88, 178, 87, 14, 317, 402, 318, 324, 308, 415, 310, 311, 312, 13, 82, 81, 80, 191, 78]
...
LANDMARK_LEFT_EYEBROW = create_landmark_path(LEFT_EYEBROW_IDX)
...
LANDMARK_RIGHT_EYEBROW = create_landmark_path(RIGHT_EYEBROW_IDX)
LANDMARK_NOSE = create_landmark_path(NOSE_IDX)
LANDMARK_MOUTH = create_landmark_path(MOUTH_IDX)
LANDMARK_LIPS_OUTER_CONTOUR = create_landmark_path(LIPS_OUTER_IDX)
LANDMARK_LIPS_INNER_CONTOUR = create_landmark_path(LIPS_INNER_IDX)
